...
const EditTask = ({ task, editTask, setEditTask, setTaskUpdate }) => {
  // ui open/close state
  ...
  }, [updatedTask, isError, error, isLoading, setEditTask, setTaskUpdate]);
